...
//        }
    ...
    public void noSchema() throws Exception {
        ...
        assertCorrect("ALTER TABLE [table_name] MODIFY [column_name] int IDENTITY", XuguDatabase.class);
        assertCorrect("ALTER TABLE [table_name] MODIFY [column_name] int IDENTITY", CAEDatabase.class);
