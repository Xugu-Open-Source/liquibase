...
public class InsertOrUpdateGeneratorXuGu extends InsertOrUpdateGenerator {
  ...
  public boolean supports(InsertOrUpdateStatement statement, Database database) {
    return database instanceof XuguDatabase;
  }
  ...
  // Copied and modified from liquibase.sqlgenerator.core.InsertOrUpdateGeneratorInformix
