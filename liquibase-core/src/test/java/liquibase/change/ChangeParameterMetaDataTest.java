...
public class ChangeParameterMetaDataTest {
    ...
    public void computedDatabasesCorrect(){
        ...
        assertSetsEqual(new String[]{"sybase","mssql","postgresql","cockroachdb","firebird","oracle","sqlite","mysql","mariadb","h2","hsqldb","db2", "ingres", "edb", "xugu", "cae"}, replaceIfExists.analyzeSupportedDatabases(new String[]{ChangeParameterMetaData.COMPUTE}));
    }
